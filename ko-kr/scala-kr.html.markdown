...
translators:
    - ["yangwansu", "https://github.com/yangwansu"]
lang: ko-kr
---
...
//
// 만약 다른 전통적인 언어를 경험 했다면 return 키워드가 누락됨을 확인 할 수 있습니다. 
// Scala 에서는 함수의 마지막 표현식이 return value 입니다. 
...
// 함수의 몸체가 하나의 표현식만 가진다면 {} 은 생략 할 수 있습니다.
def sumOfSquaresShort(x: Int, y: Int): Int = x * x + y * y

// 함수의 호출 구문은 익숙합니다.:
sumOfSquares(3, 4)  // => 25

// 파라메터의 이름을 이용하여 선언과는 다른 순서로 지정 할 수 있습니다.
def subtract(x: Int, y: Int): Int = x - y

subtract(10, 3)     // => 7
subtract(y=10, x=3) // => -7

// 대부분의 경우 Return Type 을 생략 할 수 있습니다. (재귀 함수의 경우 예외적입니다.)
// 우리가 보았던 변수의 타입추론 처럼 함수의 리턴 값 에서도 동일하게 동작 할 것입니다. 
def sq(x: Int) = x * x  // 컴파일러는 Return Type 을 Int로 추론합니다.

// 함수는 기본 파라메터를 가질 수 있습니다.:
...
// def 와 달리 익명함수에서 Input 타입은  문맥 상 명확하다면 생략 될 수 있습니다.
// Int 를 받아 Int 를 Return 하는 함수를 의미하는 "Int=>Int" 타입을 주목하라.
val sq: Int => Int = x => x * x

// 임명함수는 보통 다음처럼 호출 할 수 있습니다.
sq(10)   // => 100
